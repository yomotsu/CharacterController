...
;( function ( ns ) {
  ...
  var GyroscopeCameraControl = function ( camera, trackObject, params ) {
  ...
  GyroscopeCameraControl.prototype.update = function () {
  ...
  GyroscopeCameraControl.prototype.getFrontAngle = function () {
  ...
  // export
  ns.GyroscopeCameraControl = GyroscopeCameraControl;
